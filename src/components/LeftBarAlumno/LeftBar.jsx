...
const LeftBar = () =>{
    ...
    return(
        ...
        <div className={Styles.container}>
            ...
            <div className={Styles.menu}>
                <p className={Styles.parrafo} style={{margin: '0px'}}><Link className={Styles.lnk} href='/pantalla_filtro_libro' text="Prestamo" style={{textDecoration: 'none',paddingLeft: '45px', paddingRight:'45px', paddingTop: '20px', paddingBottom: '20px'}}>Prestamos</Link></p>
            </div>
